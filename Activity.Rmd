...
## Importing the file
```{r Import file}
setwd("D:/RTraining/curseraEnel/RStudioGitRepo/datasciencecoursera/Reproducible Research/")
file <- "D:/RTraining/curseraEnel/RStudioGitRepo/datasciencecoursera/Reproducible Research/activity.csv"
activity <- read.csv(file,header=TRUE,  sep = ",", quote = "\"",   dec = ".", fill = TRUE, comment.char = "")
